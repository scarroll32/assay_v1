...
class DataSourcesControllerTest < ActionController::TestCase
  ...
  test "should create data_source" do
    assert_difference('DataSource.count') do
      post :create, data_source: { filename: @data_source.filename, loaded_dttm: @data_source.loaded_dttm, name: @data_source.name, status: @data_source.status, version: @data_source.version }
    end
  ...
  test "should update data_source" do
    put :update, id: @data_source, data_source: { filename: @data_source.filename, loaded_dttm: @data_source.loaded_dttm, name: @data_source.name, status: @data_source.status, version: @data_source.version }
    assert_redirected_to data_source_path(assigns(:data_source))
  end
