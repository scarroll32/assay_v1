class CreatePrimer3s < ActiveRecord::Migration
  def change
    create_table :primer3s do |t|
      t.string :type
      t.references :user
      t.references :batch_detail
      t.boolean :generated
      t.string :status
  		...
  		t.integer :primer_internal_num_returned
  		t.integer :primer_pair_num_returned
  		t.string :primer_left_4_problems
  		t.string :primer_internal_4_problems
  		t.string :primer_right_4_problems
  		t.string :primer_left_explain
  		t.string :primer_internal_explain
  		t.string :primer_right_explain
  		t.string :primer_pair_explain
  		t.integer :primer_left_4
  		t.integer :primer_internal_4
  		t.integer :primer_right_4
  		t.string :primer_left_4_sequence
  		t.string :primer_internal_4_sequence
  		t.string :primer_right_4_sequence
  		t.integer :primer_pair_4_product_size
  		t.decimal :primer_left_4_penalty
  		t.decimal :primer_internal_4_penalty
  		t.decimal :primer_right_4_penalty
  		t.decimal :primer_pair_4_penalty
  		t.decimal :primer_left_4_tm
  		t.decimal :primer_internal_4_tm
  		t.decimal :primer_right_4_tm
  		t.decimal :primer_pair_4_product_tm
  		t.decimal :primer_pair_4_product_tm_oligo_tm_diff
  		t.decimal :primer_pair_4_t_opt_a
  		t.decimal :primer_left_4_gc_percent
  		t.decimal :primer_internal_4_gc_percent
  		t.decimal :primer_right_4_gc_percent
  		t.decimal :primer_left_4_self_any
  		t.decimal :primer_internal_4_self_any
  		t.decimal :primer_right_4_self_any
  		t.decimal :primer_left_4_self_any_th
  		t.decimal :primer_internal_4_self_any_th
  		t.decimal :primer_right_4_self_any_th
  		t.decimal :primer_right_4_hairpin_th
  		t.decimal :primer_pair_4_compl_any
  		t.decimal :primer_pair_4_compl_any_th
  		t.decimal :primer_left_4_self_end
  		t.decimal :primer_internal_4_self_end
  		t.decimal :primer_right_4_self_end
  		t.decimal :primer_left_4_self_end_th
  		t.decimal :primer_internal_4_self_end_th
  		t.decimal :primer_right_4_self_end_th
  		t.decimal :primer_left_4_hairpin_th
  		t.decimal :primer_internal_4_hairpin_th
  		t.decimal :primer_pair_4_compl_end
  		t.decimal :primer_pair_4_compl_end_th
  		t.decimal :primer_left_4_end_stability
  		t.decimal :primer_right_4_end_stability
  		t.decimal :primer_left_4_template_mispriming
  		t.decimal :primer_right_4_template_mispriming
  		t.decimal :primer_pair_4_template_mispriming
  		t.decimal :primer_left_4_template_mispriming_th
  		t.decimal :primer_right_4_template_mispriming_th
  		t.decimal :primer_pair_4_template_mispriming_th
  		t.decimal :primer_left_4_library_mispriming
  		t.decimal :primer_right_4_library_mispriming
  		t.decimal :primer_pair_4_library_mispriming
  		t.decimal :primer_internal_4_library_mishyb
  		t.integer :primer_left_4_min_seq_quality
  		t.integer :primer_internal_4_min_seq_quality
  		t.integer :primer_right_4_min_seq_quality
  		t.integer :primer_stop_codon_position
  		t.integer :primer_left_4_position_penalty
  		t.integer :primer_right_4_position_penalty
  
      

      t.timestamps
    end
    add_index :primer3s, :user_id
    add_index :primer3s, :batch_detail_id
  end
end
